...
public class LoanProductsApiResource {
    ...
    @Operation(summary = "Create a Loan Product", operationId = "createLoanProduct", description = """
    ...
    @GET
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "List Loan Products", operationId = "retrieveAllLoanProducts", description = """
            Lists Loan Products
    ...
    @Path("template")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(operationId = "retrieveTemplateLoanProduct", summary = "Retrieve Loan Product Details Template", description = """
    ...
    @Path("{productId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve a Loan Product", operationId = "retrieveOneLoanProduct", description = """
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(operationId = "retrieveLoanProductDetailsByExternalId", summary = "Retrieve a Loan Product", description = """
            Retrieves a Loan Product
