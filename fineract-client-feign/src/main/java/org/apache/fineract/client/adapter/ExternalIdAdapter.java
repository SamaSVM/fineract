...
public final class ExternalIdAdapter {
    ...
    public static class Serializer extends ValueSerializer<ExternalId> {
        ...
        @Override
        public void serialize(ExternalId value, JsonGenerator gen, SerializationContext serializers) {
    ...
    public static class Deserializer extends ValueDeserializer<ExternalId> {
        ...
        @Override
        public ExternalId deserialize(JsonParser p, DeserializationContext ctxt) {
